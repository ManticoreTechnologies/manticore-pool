...
var pool = module.exports = function pool(options, authorizeFn) {
    ...
    function OutputPoolInfo() {
        ...
        var infoLines = [startMessage,
            ...
            'Stratum Bind Address:\t' + (options.bindAddress || options.stratumHost || options.remoteAddress || '0.0.0.0'),
    ...
    function SetupJobManager() {
        ...
        _this.jobManager.on('newBlock', function (blockTemplate) {
            ...
            _this.emit('newBlock', blockTemplate, _this.db);
            ...
            var emitShare = function () {
                _this.emit('share', isValidShare, isValidBlock, shareData, _this.db);
            };
    ...
    function StartStratumServer(finishedCallback) {
        ...
        _this.stratumServer.on('started', function () {
            ...
            emitSpecialLog('Stratum listening on ' + (options.bindAddress || options.stratumHost || options.remoteAddress || '0.0.0.0') + ':' + options.initStats.stratumPorts.join(', '));
    ...
    function GetBlockTemplate(callback) {
        _this.daemon.cmd('getblocktemplate',
            ...
            function (result) {
                if (result.error) {
                    console.debug("result.error = %s", result);
                    //todo to string interpolation, i'm tired
                    console.error('getblocktemplate call failed for daemon instance ' +
